...
export default () =>{
 ...
 <TouchableOpacity onPress={()=>{setCreateMode(!isCreateMode)}}>
    <Text style={{alignSelf:"center", color:Colors.blue, fontSize:16,
    margin:4}}>
     ...
     <Button 
            onPress={() =>{
                ...
                if(!isValid.password){
                    passwordField.errorMessage="Password must be at least 8 words long with numbers, uppercase, lowercase and symbols";
